    ...
    with gr.Blocks(
        ...
        <div class="oncobridge-header">
            ...
            <p style="margin:6px 0 0;opacity:0.9;font-size:14px;">
                ...
                Gemma 4 + Intel Xeon 6 &nbsp;·&nbsp; RSNA 2026 Demo
            </p>
        </div>
        """)
        ...
        def run_analysis(pid, ctype, mod, img_path, vcf, notes):
            ...
            try:
                for state in pipeline.run(
                    ...
                    yield (
                        progress_text,
                        state.imaging_analysis or "",
                        metrics_display,
                        concordance_text,
                        state.genomics_summary or "",
                        variants_display,
                        trials_text,
                        state.tumor_board_report or "",
                        uncertainty_text,
                        perf,
                    )
...
║  Gemma 4 26B-A4B + Intel Xeon 6 | RSNA 2026 Demo             ║
╚══════════════════════════════════════════════════════════════╝
    """)
